...
<html lang="en">
    <head>
        ...
        <title>Admin Electronicos</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                ...
                <?php 
                   // echo $this->session->usuario->usuario;
                ?>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="<?php echo base_url().'index.php/gestionar_productos/agregar'?>">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Agregar productos
                            </a>                       
                        ...
                        <!--                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Tarjeta principal</div>
                                ...
                                <thead>
                                    ...
                                    <?php if(!empty($productos)):?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $c->pedido;?></td>

                                            <td>
                                            <a type='submit' class='btn btn-danger' href='<?php echo base_url().'index.php/gestionar_productos/eliminar_compra/'.$c->identificacion;?>'>eliminar</a>
                                            </td>
                                        </tr>
                                        <?php endforeach;?>
                                            <?php endif;?>
