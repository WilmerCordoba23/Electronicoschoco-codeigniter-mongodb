                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php endif; ?>
                                        <form action= "<?php echo base_url().'index.php/login/user/registrar'?>" method='post'>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-center-6">
                                                <div class="form-floating mb-3">
                                                      <input class="form-control"  type="text" name="nombres" placeholder="Ingrese su nombre" required/>
                                                ...
                                                <div class="col-center-6">
                                                <div class="form-floating mb-3">
                                                      <input class="form-control"  type="text" name="apellidos" placeholder="Ingrese su apellido" required/>
                                                ...
                                                <div class="col-center-6">
                                                <div class="form-floating mb-3">
                                                      <input class="form-control"   type="number" name="telefono" placeholder="Ingrese su telefono" required/>
                                                ...
                                                <div class="col-center-6">
                                                <div class="form-floating mb-3">
                                                      <input class="form-control"  type="number" name="identificacion" placeholder="Ingrese su identificacion" required/>
                                                ...
                                                <div class="col-center-6">
                                                <div class="form-floating mb-3">
                                                      <input class="form-control"  type="text" name="ciudad" placeholder="Ingrese su ciudad" required/>
                                                ...
                                                <label for="inputEmail">Dirrecion</label>
                                                         </div>
                                                </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-end mt-4 mb-0">
                                            <div class="btn btn-primary"><a class="btn btn-primary btn-block" href="<?php echo base_url().'index.php/login/user'?>">Inicia sesion</a></div>
